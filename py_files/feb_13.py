...
####################################################
#
# Author: M Joyce, Edited by Kaycee Conder
#
####################################################
#
# Kaycee Conder In Class Work for February 13th, 2025
# PHYS4840 Lab Section
#
####################################################
#
#DR JOYCE WORK BELOW
...
ax.scatter(color[quality_cut], magnitude[quality_cut]-cmd_shift, s=2,alpha=0.2, color='purple', label='HST Data')
